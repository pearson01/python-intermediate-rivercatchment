...
![Continuous Integration build in GitHub Actions](https://github.com/pearson01/python-intermediate-rivercatchment/actions/workflows/main.yml/badge.svg)
...
# Prerequisites
This software requires Python packages:
